...
@steve=User.create!(username:'stevefitnyc', email: 'steve@email.com', password: '123456', location: 'NJ', age: 35, name: 'Stephen G Csolak')
@crystal=User.create!(username:'frotbrightcry', email: 'crystal@email.com', password: '123456', location: 'Queens, NY', age: 27, name: 'Crystal Chan')
@marlyn=User.create!(username:'mhern65', email: 'marlyn@email.com', password: '123456', location: 'Long Island, NY', age: 65, name: 'Marlyn Hernandez')
@chris=User.create!(username:'cc1chris', email: 'chris@email.com', password: '123456', location: 'Yonkers, NY', age: 25, name: 'Christopher Fernandez')
@prima=User.create!(username:'primatheshiba', email: 'dog@email.com', password: '123456', location: 'USA', age: 42, name: 'Prima Shiba')
...
@seventhpost=Post.create!(title: 'Dragonboat season is here.', content: "First time on the water since last season. We started off with a short dry-land session of bodyweight drills, then got in the boat. It felt great to get back into the swing of things.", exercise_type: 'Rowing', exercise_duration: '80min', calories: 500, user_id: @crystal.id)
@eighthpost=Post.create!(title: 'Death by WOD', content: "I don't recall the name of this specific WOD, but it was intense! Here's what we did. 10min EMOM - 10/10/10 air squats, hand-release push-ups, box jumps.", exercise_type: 'Crossfit', exercise_duration: '60min', calories: 600, user_id: @crystal.id)
